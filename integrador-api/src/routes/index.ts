...
import clienteInformacionRoutes from "./clienteInformacionRoutes";
...
import personasRoutes from "./clienetRoutes";
...
import tipoClienteRoutes from "./tipoClienteRoutes";
...
router.use(clienteInformacionRoutes);
