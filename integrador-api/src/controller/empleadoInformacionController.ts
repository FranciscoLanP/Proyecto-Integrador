// src/controllers/empleadoInformacionController.ts
...
export const createEmpleadoInformacion = async (
  ...
  try {
    const { id_cliente, id_tipo_empleado, nombre, telefono, correo } = req.body;
    const newItem = new EmpleadoInformacion({
      id_cliente,
      id_tipo_empleado,
      nombre,
      telefono,
